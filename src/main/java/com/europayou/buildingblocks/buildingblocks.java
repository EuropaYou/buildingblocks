...
import com.europayou.buildingblocks.decoratives.decorative_blast_furnace;
import com.europayou.buildingblocks.decoratives.decorative_furnace;
...
/*
        ...
        /*Registry.register(Registry.BLOCK, new Identifier(id, "decorative_dispenser_furnace"), DECORATIVE_DISPENSER);
        Registry.register(Registry.ITEM, new Identifier(id, "decorative_dispenser_furnace"), new BlockItem(DECORATIVE_DISPENSER, new Item.Settings().group(ITEM_GROUP)));*/
	}
}